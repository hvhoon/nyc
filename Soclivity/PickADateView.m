...
- (void)drawRect:(CGRect)rect
{
    ...
    pickADateLabel.textAlignment = UITextAlignmentCenter;
    ...
    calendarDate=[[CalendarDateView alloc]initWithFrame:CGRectMake(0, 44, 320,304)editActivityDate:activityDate];
