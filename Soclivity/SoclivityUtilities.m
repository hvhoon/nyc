...
+(UIColor*)returnTextFontColor:(NSInteger)colorType{
    ...
    switch(colorType){
        ...
        case 1:
        {
            return [UIColor colorWithRed:154.0/255.0 green:159.0/255.0 blue:164.0/255.0 alpha:1.0];
        ...
        case 4:
        {
            return [UIColor colorWithRed:137.0/255.0 green:137.0/255.0 blue:137.0/255.0 alpha:1.0];
