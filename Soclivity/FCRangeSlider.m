...
- (void)initialize {
    ...
    NSLog(@"trackSliderWidth=%f",trackSliderWidth);
    
    outRangeTrackView = [[UIImageView alloc] initWithFrame:CGRectMake(thumbCenter, 10, trackSliderWidth, 7)];
    outRangeTrackView.contentMode = UIViewContentModeScaleToFill;
    outRangeTrackView.backgroundColor = [UIColor whiteColor];
    outRangeTrackView.layer.cornerRadius = 5;
    [self addSubview:outRangeTrackView];
    
    inRangeTrackView = [[UIImageView alloc] initWithFrame:CGRectMake(thumbCenter, 10, trackSliderWidth, 7)];
